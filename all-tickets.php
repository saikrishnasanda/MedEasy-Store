    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Medicines</a>
            </li>
                <li class="no-padding">
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Questions</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
      ...
      <section id="content">
        ...
        <!--breadcrumbs end-->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">List of questions by all customers</p>
