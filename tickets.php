    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Medicine</a>
            </li>
                <li class="no-padding">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">If you're experiencing any issues, contact us by opening a question.</p>
...
<div>
      ...
      <!-- END CONTENT -->
	        ...
	        <!--start container-->
        <div class="container">
          <p class="caption">List of your Questions</p>
          <div class="divider"></div>
