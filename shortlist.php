          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Short List</h5>
              </div>
            </div>
          </div>
        </div>
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/user-router.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">List of Details</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="price">Customer ID</th>
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM shortlist");
