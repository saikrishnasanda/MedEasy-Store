      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                ...
                <img src="images/iam.jpg" alt="" class="circle responsive-img valign profile-image">
                </div>
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Medicines</a>
            </li>
                <li class="no-padding">
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Questions</a>
                            <div class="collapsible-body">
                                <ul>
            ...
            <li class="bold"><a href="shortlist.php" class="waves-effect waves-cyan"><i class="mdi-social-person"></i> Shortlist</a>
            </li>		
        </ul>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Medicines List</h5>
              </div>
            </div>
          </div>
        </div>
